...
// import 'package:flutter_application_1/ReduxStore/actions/organization_profilepage_actions.dart';
    ...
    return StoreConnector<AppState, AppState>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: FutureBuilder<OrganizationInfo>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                OrganizationInfo org = snapshot.data!;
                return Column(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Center(
                                child:
                                    Text('Helping Hands. All rights reserved'),
                              )
                            ],
                          ),
                        ),
